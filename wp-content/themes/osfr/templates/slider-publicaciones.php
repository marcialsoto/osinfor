...
$args = array( 
	...
	'tax_query' => array ( array( 'taxonomy' => 'fuentes', 'field' => 'slug', 'terms' => 'publicaciones' ) ),
	'posts_per_page' => -1 
);
// the query
...
<?php if ( $the_query->have_posts() ) : ?>
	...
	<!-- pagination here -->
	<div id="slider__publicaciones" class="owl-carousel slider__publicaciones animated bounceInRight">	
	<!-- the loop -->
