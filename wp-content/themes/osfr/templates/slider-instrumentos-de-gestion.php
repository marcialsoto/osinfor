...
$args = array( 
	...
	'tax_query' => array ( array( 'taxonomy' => 'fuentes', 'field' => 'slug', 'terms' => 'instrumentos-de-gestion' ) ),
	'posts_per_page' => -1 
);
// the query
...
<?php if ( $the_query->have_posts() ) : ?>
	...
	<!-- pagination here -->
	<div id="slider__instrumentos-de-gestion" class="owl-carousel slider__publicaciones animated bounceInRight">	
	<!-- the loop -->
